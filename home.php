    ...
    <div class="slider-parallax-inner">
        <div id="rev_slider_579_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="default-slider" style="padding:0px;">
            ...
            <div id="rev_slider_579_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.1.4">
                <ul>   <!-- SLIDE  -->
                    <li class="dark" data-transition="fade" data-slotamount="1" data-masterspeed="400" data-thumb="./assets/img/slider/rev/main/s1-thumb.jpg"  data-saveperformance="off"  data-title="Welcome to Canvas">
                        <!-- MAIN IMAGE -->
                        <img src="./assets/img/videos/explore-poster.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <div class="tp-fade fadeout fullscreenvideo rs-background-video-layer"
                             ...
                             data-videomp4="./assets/img/videos/explore.mp4"
                    ...
                    <li class="dark" data-transition="slideup" data-slotamount="1" data-masterspeed="1000" data-thumb="./assets/img/slider/rev/main/s2-thumb.jpg"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="Unlimited Homepages">
                        <!-- MAIN IMAGE -->
                        <img src="./assets/img/slider/rev/main/s2-bg.jpg"  alt="video_woman_cover3"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                        <!-- LAYER NR. 2 -->
                        <div class="tp-caption ltl tp-resizeme rs-parallaxlevel-8"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="1000"
                             data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap;"><img src="./assets/img/slider/rev/main/s2-1.png" alt="Image"></div>
                        ...
                        <div class="tp-caption ltl tp-resizeme rs-parallaxlevel-7"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="1000"
                             data-endeasing="Power4.easeIn" style="z-index: 4;"><img src="./assets/img/slider/rev/main/s2-2.png" alt="Image"></div>
                        ...
                        <div class="tp-caption ltl tp-resizeme rs-parallaxlevel-6"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="1000"
                             data-endeasing="Power4.easeIn" style="z-index: 5;"><img src="./assets/img/slider/rev/main/s2-3.png" alt="Image"></div>
                        ...
                        <div class="tp-caption ltl tp-resizeme rs-parallaxlevel-5"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="1000"
                             data-endeasing="Power4.easeIn" style="z-index: 6;"><img src="./assets/img/slider/rev/main/s2-4.png" alt="Image"></div>
                        ...
                        <div class="tp-caption ltl tp-resizeme rs-parallaxlevel-4"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="1000"
                             data-endeasing="Power4.easeIn" style="z-index: 7;"><img src="./assets/img/slider/rev/main/s2-5.png" alt="Image"></div>
                        ...
                        <div class="tp-caption ltl tp-resizeme rs-parallaxlevel-3"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="1000"
                             data-endeasing="Power4.easeIn" style="z-index: 8;"><img src="./assets/img/slider/rev/main/s2-6.png" alt="Image"></div>
                        ...
                        <div class="tp-caption ltl tp-resizeme rs-parallaxlevel-2"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="1000"
                             data-endeasing="Power4.easeIn" style="z-index: 9;"><img src="./assets/img/slider/rev/main/s2-7.png" alt="Image"></div>
                        ...
                        <div class="tp-caption ltl tp-resizeme rs-parallaxlevel-1"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="1000"
                             data-endeasing="Power4.easeIn" style="z-index: 10;"><img src="./assets/img/slider/rev/main/s2-8.png" alt="Image"></div>
                    ...
                    <li data-transition="slideup" data-slotamount="1" data-masterspeed="1500" data-thumb="./assets/img/slider/rev/main/s3-thumb.jpg" data-delay="10000"  data-saveperformance="off"  data-title="Responsive &amp; Retina">
                        <!-- MAIN IMAGE -->
                        <img src="./assets/img/slider/rev/main/s3.jpg"  alt="kenburns6"  data-bgposition="left top" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-scalestart="130" data-scaleend="100" data-bgpositionend="right bottom">
                        <!-- LAYERS -->
    ...
    <div class="content-wrap">
        ...
        <div class="container clearfix">
            ...
            <div class="divcenter center clearfix" style="max-width: 900px;">
                <img class="bottommargin" src="./assets/img/logo-side.png" alt="">
        ...
        <div class="section parallax dark nobottommargin nobottomborder" style="background: url('./assets/img/parallax/7.jpg');" data-stellar-background-ratio="0.3">
            ...
            <div class="container clearfix">
                ...
                <div style="position: relative; margin-bottom: -60px;" data-height-lg="415" data-height-md="342" data-height-sm="262" data-height-xs="160" data-height-xxs="102">
                    <img src="./assets/img/services/chrome.png" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" alt="Chrome">
                    <img src="./assets/img/services/ipad3.png" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="300" alt="iPad">
                </div>
        ...
        <div id="portfolio" class="portfolio grid-container portfolio-nomargin portfolio-notitle portfolio-full clearfix">
            ...
            <article class="portfolio-item pf-media pf-icons">
                <div class="portfolio-image">
                    <a href="portfolio-single.html">
                        <img src="./assets/img/portfolio/4/1.jpg" alt="Open Imagination">
                    </a>
                    <div class="portfolio-overlay">
                        <a href="./assets/img/portfolio/full/1.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
            ...
            <article class="portfolio-item pf-illustrations">
                <div class="portfolio-image">
                    <a href="portfolio-single.html">
                        <img src="./assets/img/portfolio/4/2.jpg" alt="Locked Steel Gate">
                    </a>
                    <div class="portfolio-overlay">
                        <a href="./assets/img/portfolio/full/2.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
                        <a href="portfolio-single.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                    </div>
                </div>
                <div class="portfolio-desc">
            ...
            <article class="portfolio-item pf-graphics pf-uielements">
                <div class="portfolio-image">
                    <a href="#">
                        <img src="./assets/img/portfolio/4/3.jpg" alt="Mac Sunglasses">
                    </a>
                    <div class="portfolio-overlay">
                    ...
                    <div class="fslider" data-arrows="false" data-speed="400" data-pause="4000">
                        <div class="flexslider">
                            <div class="slider-wrap">
                                <div class="slide"><a href="portfolio-single-gallery.html"><img src="./assets/img/portfolio/4/4.jpg" alt="Morning Dew"></a></div>
                                <div class="slide"><a href="portfolio-single-gallery.html"><img src="./assets/img/portfolio/4/4-1.jpg" alt="Morning Dew"></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="portfolio-overlay" data-lightbox="gallery">
                        <a href="./assets/img/portfolio/full/4.jpg" class="left-icon" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
                        <a href="./assets/img/portfolio/full/4-1.jpg" class="hidden" data-lightbox="gallery-item"></a>
            ...
            <article class="portfolio-item pf-uielements pf-media">
                <div class="portfolio-image">
                    <a href="portfolio-single.html">
                        <img src="./assets/img/portfolio/4/5.jpg" alt="Console Activity">
                    </a>
                    <div class="portfolio-overlay">
                        <a href="./assets/img/portfolio/full/5.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
                        <a href="portfolio-single.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                    </div>
                </div>
                <div class="portfolio-desc">
            ...
            <article class="portfolio-item pf-graphics pf-illustrations">
                <div class="portfolio-image">
                    <div class="fslider" data-arrows="false">
                        <div class="flexslider">
                            <div class="slider-wrap">
                                <div class="slide"><a href="portfolio-single-gallery.html"><img src="./assets/img/portfolio/4/6.jpg" alt="Shake It"></a></div>
                                <div class="slide"><a href="portfolio-single-gallery.html"><img src="./assets/img/portfolio/4/6-1.jpg" alt="Shake It"></a></div>
                                <div class="slide"><a href="portfolio-single-gallery.html"><img src="./assets/img/portfolio/4/6-2.jpg" alt="Shake It"></a></div>
                                <div class="slide"><a href="portfolio-single-gallery.html"><img src="./assets/img/portfolio/4/6-3.jpg" alt="Shake It"></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="portfolio-overlay" data-lightbox="gallery">
                        <a href="./assets/img/portfolio/full/6.jpg" class="left-icon" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
                        <a href="./assets/img/portfolio/full/6-1.jpg" class="hidden" data-lightbox="gallery-item"></a>
                        <a href="./assets/img/portfolio/full/6-2.jpg" class="hidden" data-lightbox="gallery-item"></a>
                        <a href="./assets/img/portfolio/full/6-3.jpg" class="hidden" data-lightbox="gallery-item"></a>
                        <a href="portfolio-single-gallery.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                    </div>
                </div>
                <div class="portfolio-desc">
            ...
            <article class="portfolio-item pf-uielements pf-icons">
                <div class="portfolio-image">
                    <a href="portfolio-single-video.html">
                        <img src="./assets/img/portfolio/4/7.jpg" alt="Backpack Contents">
                    </a>
                    <div class="portfolio-overlay">
            ...
            <article class="portfolio-item pf-graphics">
                <div class="portfolio-image">
                    <a href="portfolio-single.html">
                        <img src="./assets/img/portfolio/4/8.jpg" alt="Sunset Bulb Glow">
                    </a>
                    <div class="portfolio-overlay">
                        <a href="./assets/img/portfolio/full/8.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
                        <a href="portfolio-single.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                    </div>
                </div>
                <div class="portfolio-desc">
        ...
        <div class="container clearfix">
            ...
            <div class="col_three_fifth topmargin-sm bottommargin">
                <img data-animate="fadeInLeftBig" src="./assets/img/services/imac.png" alt="Imac">
            </div>
        ...
        <div class="container divcenter clearfix">
            ...
            <div style="position: relative;" data-height-lg="624" data-height-md="518" data-height-sm="397" data-height-xs="242" data-height-xxs="154">
                <img src="./assets/img/services/fbrowser.png" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="100" alt="Chrome">
                <img src="./assets/img/services/fmobile.png" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="400" alt="iPad">
                <img src="./assets/img/services/fbrowser2.png" style="position: absolute; top: 0; left: 0;" data-animate="fadeIn" data-delay="1200" alt="iPad">
            </div>
        </div>
        ...
        <div class="section dark parallax notopmargin nobottommargin noborder" style="height: 500px; padding: 145px 0;">
            ...
            <div class="video-wrap">
                <video poster="./assets/img/videos/messiermarathon.jpg" preload="none" loop autoplay muted>
                    <source src='./assets/img/videos/messiermarathon.mp4' type='video/mp4' />
                    <source src='./assets/img/videos/messiermarathon.webm' type='video/webm' />
                </video>
        ...
        <div class="container clearfix">
            ...
            <div class="col_two_third nobottommargin">
                ...
                <div class="col_half nobottommargin">
                    <div class="ipost clearfix">
                        <div class="entry-image">
                            <a href="#"><img class="image_fade" src="./assets/img/magazine/thumb/11.jpg" alt="Image"></a>
                        </div>
                ...
                <div class="col_half col_last nobottommargin">
                    <div class="ipost clearfix">
                        <div class="entry-image">
                            <a href="#"><img class="image_fade" src="./assets/img/magazine/thumb/14.jpg" alt="Image"></a>
                        </div>
                        <div class="entry-title">
                        ...
                        <div class="slider-wrap">
                            <div class="slide">
                                <div class="testi-image">
                                    <a href="#"><img src="./assets/img/testimonials/3.jpg" alt="Customer Testimonails"></a>
                                </div>
                            ...
                            <div class="slide">
                                <div class="testi-image">
                                    <a href="#"><img src="./assets/img/testimonials/2.jpg" alt="Customer Testimonails"></a>
                                </div>
                                <div class="testi-content">
                            ...
                            <div class="slide">
                                <div class="testi-image">
                                    <a href="#"><img src="./assets/img/testimonials/1.jpg" alt="Customer Testimonails"></a>
                                </div>
                                <div class="testi-content">
        ...
        <div class="section nobottommargin">
            <div class="container clearfix">
                ...
                <div class="subscribe-widget">
                    ...
                    <form id="widget-subscribe-form2" action="./assets/include/subscribe.php" role="form" method="post" class="nobottommargin">
        ...
        <div id="oc-clients" class="section nobgcolor notopmargin owl-carousel owl-carousel-full image-carousel footer-stick carousel-widget" data-margin="80" data-loop="true" data-nav="false" data-autoplay="5000" data-pagi="false" data-items-xxs="2" data-items-xs="3" data-items-sm="4" data-items-md="5" data-items-lg="6">
            ...
            <div class="oc-item"><a href="#"><img src="./assets/img/clients/1.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="./assets/img/clients/2.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="./assets/img/clients/3.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="./assets/img/clients/4.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="./assets/img/clients/5.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="./assets/img/clients/6.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="./assets/img/clients/7.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="./assets/img/clients/8.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="./assets/img/clients/9.png" alt="Clients"></a></div>
            <div class="oc-item"><a href="#"><img src="./assets/img/clients/10.png" alt="Clients"></a></div>

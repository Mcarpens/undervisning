<!-- Page Title
		============================================= -->
<section id="page-title" class="page-title-parallax page-title-dark" style="padding: 250px 0; background-image: url('./assets/img/about/parallax.jpg'); background-size: cover; background-position: center center;" data-stellar-background-ratio="0.4">
...
<section id="content">
    ...
    <div class="content-wrap">
        ...
        <div class="row common-height clearfix">
            ...
            <div class="col-sm-5 col-padding" style="background: url('./assets/img/team/3.jpg') center center no-repeat; background-size: cover;"></div>
        ...
        <div class="row common-height bottommargin-lg clearfix">
            ...
            <div class="col-sm-5 col-padding" style="background: url('./assets/img/team/8.jpg') center center no-repeat; background-size: cover;"></div>
        ...
        <div class="container clearfix">
            ...
            <ul class="clients-grid grid-6 nobottommargin clearfix">
                <li><a href="http://logofury.com/logo/enzo.html"><img src="./assets/img/clients/1.png" alt="Clients"></a></li>
                <li><a href="http://logofury.com"><img src="./assets/img/clients/2.png" alt="Clients"></a></li>
                <li><a href="http://logofaves.com/2014/03/grabbt/"><img src="./assets/img/clients/3.png" alt="Clients"></a></li>
                <li><a href="http://logofaves.com/2014/01/ladera-granola/"><img src="./assets/img/clients/4.png" alt="Clients"></a></li>
                <li><a href="http://logofaves.com/2014/02/hershel-farms/"><img src="./assets/img/clients/5.png" alt="Clients"></a></li>
                <li><a href="http://logofury.com/logo/food-fight-radio.html"><img src="./assets/img/clients/6.png" alt="Clients"></a></li>
                <li><a href="http://logofury.com"><img src="./assets/img/clients/7.png" alt="Clients"></a></li>
                <li><a href="http://logofury.com/logo/up-travel.html"><img src="./assets/img/clients/8.png" alt="Clients"></a></li>
                <li><a href="http://logofury.com/logo/caffi-bardi.html"><img src="./assets/img/clients/9.png" alt="Clients"></a></li>
                <li><a href="http://logofury.com/logo/bignix-design.html"><img src="./assets/img/clients/10.png" alt="Clients"></a></li>
                <li><a href="http://logofury.com/"><img src="./assets/img/clients/11.png" alt="Clients"></a></li>
                <li><a href="http://logofury.com/"><img src="./assets/img/clients/12.png" alt="Clients"></a></li>
            </ul>

                            ...
                            <div class="fslider" data-pagi="false" data-arrows="false" data-thumbs="true">
                                <div class="flexslider">
                                    <div class="slider-wrap" data-lightbox="gallery">
                                        <div class="slide" data-thumb="./assets/img/produkter/<?= $singleProd->image ?>"><a href="./assets/img/produkter/<?= $singleProd->image ?>" title="<?= $singleProd->name ?>" data-lightbox="gallery-item"><img src="./assets/img/produkter/<?= $singleProd->image ?>" alt="<?= $singleProd->name ?>"></a></div>
                                    </div>
                                </div>
                            </div>
<!--                            <div class="sale-flash">Sale!</div>-->
                    ...
                    <div class="col_two_fifth product-desc">
                        ...
                        ============================================= -->
                        <div class="product-price"><?= $singleProd->price ?> DKK</div><!-- Product Single - Price End -->
...
<!--                        </div><!-- Product Single - Rating End -->
                        ...
                        <form class="cart nobottommargin clearfix" method="post" enctype='multipart/form-data'>
                            ...
                            <button type="submit" class="add-to-cart button nomargin">Tilføj til Kurv</button>
...
<!--                        </ul><!-- Product Single - Short Description End -->
                        ...
                        <div class="panel panel-default product-meta">
                            <div class="panel-body">
                                <span itemprop="productID" class="sku_wrapper">SKU: <span class="sku"><?= $singleProd->product_number ?></span></span>
...
<!--                        </div><!-- Product Single - Share End -->
                    ...
                    <div class="col_one_fifth col_last">
                        ...
                        <a href="#" title="Brand Logo" class="hidden-xs"><img class="image_fade" src="./assets/img/shop/brand.jpg" alt="Brand Logo"></a>
